...
class NodoArvore:
    ...
    def maior_elemento(self, raiz):
        """ Encontra o maior elemento de uma árvore binária de pesquisa"""
        atual = raiz
...
menorElemento= raiz.menor_elemento(raiz)
if menorElemento:
    print(f'O menor elemento é: {menorElemento.chave}')



maiorElemento = raiz.maior_elemento(raiz)
if maiorElemento:
    print(f'O maior elemento é: {maiorElemento.chave}')
